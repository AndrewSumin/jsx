 ...
 * Migrate.
 * 
 * Don't foget add jsx.loaded('{ZC}.zen_textarea');
 * And add check on line
 *   if(opt['disable_in_input'] || element.className.indexOf('zen-coding') == -1) {
 * check classname 'zen-coding' to work only on pointed textareas
 */
...
shortcut = {
  ...
  'add': function(shortcut_combination,callback,opt) {
    ...
    var func = function(e) {
      ...
      if(opt['disable_in_input'] || element.className.indexOf('zen-coding') == -1) { //Don't enable shortcut keys in Input, Textarea fields
