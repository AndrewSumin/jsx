...
function assertEquals() {
  ...
  var isEqual = (var1 === var2);
  if (typeof(var1) == 'object' && typeof(var2) == 'object') {
      isEqual = _compareObjects(var1, var2);
  }
  _assert(commentArg(2, arguments), isEqual, 'Expected ' + var1 + ' (' + typeof(var1) + ') but was ' + _displayStringForValue(var2) + ' (' + typeof(var2) + ')');
}
...
function assertNotEquals() {
  ...
  _assert(commentArg(2, arguments), !isEqual, 'Expected not to be ' + _displayStringForValue(var2));
}
